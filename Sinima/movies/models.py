...
class Actor(models.Model):
    ...
    photo = models.ImageField(upload_to='actor_photos/', verbose_name='Фото')
...
class Genre(models.Model):
    ...
    def __str__(self):
        return f'Жанр: {self.name} id: {self.pk}'
...
class Movie(models.Model):
    ...
    release_date = models.DateField(verbose_name='Премьера')
    ...
    age_requirement = models.CharField(
        max_length=3,
        choices=AGE_REQUIREMENT,
        default=AGE_REQUIREMENT.get('0+'),
        verbose_name='Возрастной рейтинг'
    )
    country = models.CharField(
        max_length=3,
        choices=COUNTRIES,
        default=COUNTRIES.get('RU'),
        verbose_name='Страна'
    )
